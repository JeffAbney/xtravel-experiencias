    ...
    <LanguageContext.Provider value={{ language, setLanguage }}>
      <Router>
        <Switch>
          ...
          <Route path="/experiences" exact render={(props) => <Home {...props} reservationData={reservationData} setReservationData={setReservationData} price={price} setPrice={setPrice} setExperience={setExperience} />} />
